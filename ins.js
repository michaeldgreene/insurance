...
, function(t, e, n) {
    ...
    ;
    var g, m = navigator.userAgent.toLowerCase(), b = r.env.touch = "ontouchstart"in window || window.DocumentTouch && document instanceof window.DocumentTouch, w = r.env.chrome = /chrome/.test(m) && /Google/.test(navigator.vendor) && parseInt(m.match(/chrome\/(\d+)\./)[1], 10), x = r.env.ios = /(ipod|iphone|ipad)/.test(m);
    r.env.safari = /safari/.test(m) && !w && !x,
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        return null == t ? void 0 === t ? u : a : (t = Object(t),
        c && c in t ? i(t) : o(t))
    }
}
, function(t, e, n) {
...
, function(t, e, n) {
    ...
    function s() {
        ...
        e;
        function e(n, o) {
            Array.isArray(n) && Array.isArray(o) || r(!Array.isArray(o), "update(): You provided an invalid spec to update(). The spec may not contain an array except as the value of $set, $push, $unshift, $splice or any custom command allowing an array value."),
            r("object" == typeof o && null !== o, "update(): You provided an invalid spec to update(). The spec and every included key path must be plain objects containing one of the following commands: %s.", Object.keys(t).join(", "));
            var a = n;
            u(o);
    ...
    var f = {
        ...
        $unshift: function(t, e, n) {
            return l(e, n, "$unshift"),
            t.concat(e)
        },
        $splice: function(t, e, n, i) {
            var a = e === i ? c(i) : e;
            return function(t, e) {
                r(Array.isArray(t), "Expected $splice target to be an array; got %s", t),
                d(e.$splice)
            }(a, n),
        ...
        $unset: function(t, e, n, i) {
            ...
            return t.forEach(function(t) {
                Object.hasOwnProperty.call(o, t) && (e === i && (e = c(i)),
                delete e[t])
            }),
            e
        },
        ...
        $apply: function(t, e) {
            var n;
            return r("function" == typeof (n = t), "update(): expected spec of $apply to be a function; got %s.", n),
            t(e)
        }
    };
    function l(t, e, n) {
...
, function(t, e, n) {
    ...
    e.g = function(t) {
        ...
        case v.l:
            return function(t, e) {
                ...
                switch (e) {
                case v.i:
                    var i = [q(k, t), q(M, t), q(P, t)];
                    return r(i);
                case v.k:
                    var o = [q(C, t), q(L, t), q(R, t)];
                    return r(o);
                case v.j:
        ...
        case v.g:
            var c = o(e, y.E)
              ...
              , l = void 0
              , d = void 0;
            return l = u.widthUnit === y.a ? S.test(c) ? parseFloat(c) : parseFloat(i.width) : s()(parseFloat(c), parseFloat(i.width)),
            ...
            return function(t, e) {
                var n = t.element
                  ...
                  , c = function(t, e, n) {
                    ...
                    switch (r) {
                    case v.i:
                        return void 0 !== l && (h = B(h, k, y.A, l + a)),
                        void 0 !== d && (h = B(h, M, y.B, d + c)),
                        void 0 !== p && (h = B(h, P, y.C, p + f)),
                        h;
                    case v.k:
                        return void 0 !== l && (h = B(h, C, y.t, l + a)),
                        void 0 !== d && (h = B(h, L, y.u, d + c)),
                        void 0 !== p && (h = B(h, R, y.v, p + f)),
                        h;
                    case v.j:
                        return void 0 !== l && (h = B(h, D, y.q, l + a)),
                        void 0 !== d && (h = B(h, N, y.r, d + c)),
                        void 0 !== p && (h = B(h, V, y.s, p + f)),
                        h;
                    case v.l:
                        return void 0 !== l && (h = B(h, z, y.x, l + a)),
                        void 0 !== d && (h = B(h, $, y.y, d + c)),
                        h;
                    default:
                        return h
                    }
            ...
            return function(t, e) {
                ...
                case v.h:
                    var m = x[u]
                      ...
                      , O = i.aValue;
                    H(n, m, e),
                    a(n, m, O >= 1 ? "rgb(" + Math.round(b) + "," + Math.round(w) + "," + Math.round(_) + ")" : "rgba(" + Math.round(b) + "," + Math.round(w) + "," + Math.round(_) + "," + O + ")");
                    break;
                default:
                    var j = c.unit
                      , E = void 0 === j ? "" : j;
    ...
    e.a = function(t, e) {
        ...
        if (a === v.g) {
            var u = n.config;
            u.widthUnit === y.a && i(r, y.E, ""),
            u.heightUnit === y.a && i(r, y.m, "")
        }
        o(r, y.F) && Y({
            effect: U,
            actionTypeId: a,
    ...
    ;
    var r, i, o, a = n(19), u = n.n(a), c = n(213), s = n.n(c), f = n(214), l = n.n(f), d = n(12), p = n.n(d), v = (n(54),
    n(41)), h = n(42), y = n(22), g = n(79), m = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        return typeof t
    }
    : function(t) {
    ...
    var w = function(t) {
      ...
      , x = Object.freeze((b(r = {}, v.d, y.c),
    b(r, v.e, y.e),
    b(r, v.h, y.i),
    r))
      , _ = Object.freeze((b(i = {}, g.d, y.z),
    b(i, y.c, y.b),
    b(i, y.p, y.p),
    b(i, y.E, y.E),
    b(i, y.m, y.m),
    ...
    function I(t) {
        ...
        var S = u()(n, "action.config.affectedElements", {})[w || x] || {}
          ...
          , M = void 0
          , P = n && c(E(n.target));
        if (T ? (A = S.limitAffectedElements,
        k = P,
        M = c(S)) : k = M = c({
            id: w,
            selector: x,
        ...
        return null == k || null == M ? [] : g.c && i ? s(M).filter(function(t) {
            return i.contains(t)
        }) : A === y.g ? s(k, M) : A === y.n ? f(s(k)).filter(d(M)) : A === y.w ? l(s(k)).filter(d(M)) : s(M)
    }
    var S = /px/;
    ...
    o)
      ...
      , F = Object.keys(T).map(function(t) {
        ...
        switch (t) {
        case v.i:
            return G([[y.A, n], [y.B, r], [y.C, i]]);
        case v.k:
            return G([[y.t, n], [y.u, r], [y.v, i]]);
        case v.j:
            return G([[y.q, n], [y.r, r], [y.s, i]]);
        case v.l:
            return G([[y.x, n], [y.y, r]]);
        default:
            return ""
        }
    }).join(" ");
        ...
        if (g.c) {
            ...
            if (r) {
                ...
                if (a) {
                    ...
                    -1 === u.indexOf(r) && o(t, y.F, u.concat(r).join(y.j))
                } else
                    o(t, y.F, r)
            }
        }
        ...
        if (g.c) {
            ...
            if (r) {
                var i = n.getStyle
                  , o = n.setStyle
                  , a = i(t, y.F);
                a && -1 !== a.indexOf(r) && o(t, y.F, a.split(y.j).map(w).filter(function(t) {
                    return t !== r
                }).join(y.j))
            }
        }
        ...
        var L = e.frame = function() {
          ...
          , V = f(function(t) {
            ...
            t.init = function(t, e, n, r) {
                ...
                this.string = this.name + I + this.duration + "ms" + ("ease" != this.ease ? I + l[this.ease][0] : "") + (this.delay ? I + this.delay + "ms" : ""))
            }
            ,
            t.set = function(t) {
...
, function(t, e, n) {
    ...
    var M = navigator.userAgent
      , P = M.match(/iPad/i) || M.match(/iPhone/)
      , C = 12;
    function L(t, e) {
        z({
            store: e,
            ...
            y()(n, function(t) {
                if (!t.continuous) {
                    var n = t.actionListId
                      , r = t.verbose;
                    K(t, e),
                    r && e.dispatch(Object(E.actionListPlaybackChanged)({
                        actionListId: n,
                        isPlaying: !1
                    }))
                }
    ...
    function z(t) {
        ...
        o.active || (e.dispatch(Object(E.sessionInitialized)({
        ...
        r && function(t) {
                ...
                r ? function(t) {
                    ...
                    if (c()(l)) {
                        y()(l, function(t, e) {
                            ...
                            (u.actionTypeId === T.c || R(u.actionTypeId)) && W({
                                store: n,
                                actionListId: s,
                                eventId: c
                            })
                        ...
                        var d = function(t) {
                          ...
                          , v = function(t) {
                            ...
                            i.split(" ").filter(Boolean).forEach(function(t) {
                                ...
                                n.dispatch(Object(E.eventListenerAdded)(r, [t, e]))
                            })
                        };
            ...
            t.getState().ixSession.eventListeners.length && function(t) {
                ...
                G.forEach(function(n) {
                    ...
                    t.dispatch(Object(E.eventListenerAdded)(window, [n, e]))
                }),
                e()
            }(t)
        }(e),
        ...
        function(t) {
            !function e(n) {
                var r = t.getState()
                  , i = r.ixSession
                  , o = r.ixParameters;
                i.active && (t.dispatch(Object(E.animationFrameChanged)(n, o)),
    ...
    function $(t) {
        ...
        e.active && (e.eventListeners.forEach(F),
        t.dispatch(Object(E.sessionStopped)()))
    }
    function F(t) {
        var e = t.target
          , n = t.listenerParams;
        ...
        y()(c, function(t) {
            ...
            if (t.actionListId === o && t.eventId === n && u) {
                if (s && r && !I.elementContains(s, t.element))
                    return;
                K(t, e),
                t.verbose && e.dispatch(Object(E.actionListPlaybackChanged)({
                    actionListId: o,
                    isPlaying: !1
                }))
            }
    ...
    function U(t) {
        ...
        c >= m.length && a()(v, "config.loop") && (c = 0),
    ...
    function Q(t) {
        ...
        i ? function(t, e) {
            ...
            t.dispatch(Object(E.animationFrameChanged)(Number.POSITIVE_INFINITY, n)),
    ...
    function K(t, e) {
        Object(O.a)(t, I),
        e.dispatch(Object(E.instanceRemoved)(t.id))
    }
    function Y(t, e) {
        var n = t.active
          , r = t.continuous
        ...
        if (Object(O.n)(m, y.mediaQueryKey) && (r || n || i) && ((o || l && i) && Object(O.m)(t, I),
        i)) {
            if (d) {
                var b = U({
                    store: e,
...
, function(t, e, n) {
    ...
    r.define("brand", t.exports = function(t) {
        var e, n = {}, i = t("html"), o = t("body"), a = ".w-webflow-badge", u = window.location, c = /PhantomJS/i.test(navigator.userAgent);
        function s() {
            var t = o.children(a)
        ...
        return n.ready = function() {
            var n, r, o, a = i.attr("data-wf-status"), f = i.attr("data-wf-domain") || "";
            /\.webflow\.io$/i.test(f) && u.hostname !== f && (a = !0),
            a && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"),
            r = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-icon.60efbf6ec9.svg").css({
                marginRight: "8px",
                width: "16px"
            }),
            o = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-text.6faa6a38cd.svg"),
            n.append(r, o),
            n[0]),
            s(),
            setTimeout(s, 500))
    ...
    t.exports = function() {
        ...
        return t.template = function(e, n, r) {
            ...
            e.replace(i, function(t, n, r, i, u) {
                return a += e.slice(o, u).replace(m, b),
                o = u + t.length,
...
, function(t, e, n) {
    ...
    r.define("edit", t.exports = function(t, e, n) {
        ...
        function d(e) {
            ...
            n.indexOf("//") >= 0 ? n : v("https://editor-api.webflow.com" + n)), function() {
...
, function(t, e, n) {
    ...
    r.define("forms", t.exports = function(t, e) {
        var i = {};
        n(88);
        var o, a, u, c = t(document), s = window.location, f = window.XDomainRequest && !window.atob, l = ".w-form", d = /e(-)?mail/i, p = /^\S+@\S+$/, v = window.alert, h = r.env(), y = /list-manage[1-9]?.com/i, g = e.debounce(function() {
        ...
        function m(e, n) {
            ...
            y.test(u) ? i.handler = O : u || (a ? i.handler = _ : g())
        }
        function b(t) {
        ...
        function _(e) {
            ...
            a) {
                ...
                f && u.indexOf("https://webflow.com") >= 0 && (u = u.replace("https://webflow.com", "http://formdata.webflow.com")),
                t.ajax({
                    url: u,
                    type: "POST",
                    data: i,
        ...
        return i.ready = i.design = i.preview = function() {
            !function() {
                if (a = t("html").attr("data-wf-site"),
                !(o = t(l + " form")).length)
                    return;
                o.each(m)
            }(),
            h || u || (u = !0,
            c.on("submit", l + " form", function(e) {
                var n = t.data(this, l);
                n.handler && (n.evt = e,
                n.handler(n))
            }))
...
, function(t, e, n) {
    ...
    var r, i = n(6), o = n(12), a = n.n(o), u = Object.assign || function(t) {
        for (var e = 1; e < arguments.length; e++) {
            var n = arguments[e];
            for (var r in n)
                Object.prototype.hasOwnProperty.call(n, r) && (t[r] = n[r])
...
, function(t, e, n) {
    ...
    var c = function(t, e) {
        ...
        if (g && !m)
            ...
            for (var P = (h - b) / w, C = g.config.easing, L = Object(a.a)(C, P), R = 0, D = u.length; R < D; R++) {
                var N = u[R]
                  , V = g.config[N]
                  , z = (m.config[N] - V) * L + V;
                T[N] = z
      ...
      , f = function() {
        ...
        case r.f:
            var n = e.payload
              ...
              , P = Object.keys(m).filter(function(t) {
                return null != m[t]
            });
            return o()(t, u({}, i, {
                $set: {
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n, y, g, m) {
        ...
        if (E && !O)
            return m || (m = new r),
            b || f(t) ? i(t, e, n, y, g, m) : o(t, e, x, n, y, g, m);
        if (!(n & l)) {
...
, function(t, e, n) {
    var r = n(169)
      ...
      , u = r(function(t) {
        var e = [];
        return i.test(t) && e.push(""),
        t.replace(o, function(t, n, r, i) {
...
, function(t, e, n) {
    var r = n(2)
      ...
      , c = Math.min;
    t.exports = function(t, e, n) {
        var s, f, l, d, p, v, h = 0, y = !1, g = !1, m = !0;
        if ("function" != typeof t)
...
, function(t, e, n) {
    "use strict";
    e.__esModule = !0;
    var r, i = n(212), o = (r = i) && r.__esModule ? r : {
        default: r
    };
    e.default = o.default
}
...
, function(t, e, n) {
        ...
        if (e) {
            ...
            if (-1 !== e.indexOf(r.o)) {
                var o = e.split(r.o)
                  , a = o[0];
                if (i = o[1],
                a !== document.documentElement.getAttribute(r.D))
                    return null
            }
            return '[data-w-id^="' + i + '"]'
        }
    ...
    e.getValidDocument = function(t) {
        if (null == t || t === document.documentElement.getAttribute(r.D))
            return document;
        return null
    }
    ,
...
, function(t, e, n) {
    "use strict";
    var r, i = n(219), o = n.n(i), a = n(19), u = n.n(a), c = n(238), s = n.n(c), f = n(55), l = n(40), d = n(43), p = n(42), v = n(22), h = Object.assign || function(t) {
        for (var e = 1; e < arguments.length; e++) {
            var n = arguments[e];
            for (var r in n)
                Object.prototype.hasOwnProperty.call(n, r) && (t[r] = n[r])
    ...
    function() {
        ...
        return function(e) {
            ...
            var y = (l ? f : a * (f || 0) / 100) / d
              ...
              , b = 0;
            n && (g = v > n.percentTop,
            b = (m = n.scrollingDown !== g) ? v : n.anchorTop);
        ...
        handler: (w = function(t, e) {
            var n = e.elementVisible
              , r = t.event;
            return !t.store.getState().ixData.events[r.action.config.autoStopEventId] && e.triggered ? e : r.eventTypeId === p.v === n ? (I(t),
            h({}, e, {
                triggered: !0
            })) : e
        }
        ...
        function(t, e) {
            var n = h({}, e, {
                elementVisible: function(t) {
                    var e, n, r = t.element, i = t.event.config, o = P(), a = o.clientWidth, u = o.clientHeight, c = i.scrollOffsetValue, s = "PX" === i.scrollOffsetUnit ? c : u * (c || 0) / 100;
        ...
        handler: function(t) {
            ...
            case p.o:
                var k = P()
                  ...
                  , L = k.scrollWidth
                  , R = k.scrollHeight;
                S = E ? Math.min(M + x, L) / L : Math.min(C + O, R) / R;
                break;
            case p.e:
            default:
                T = Object(l.i)(o, s);
            ...
            return I && (S > .95 || S < .05) && (S = Math.round(S)),
            (u !== p.e || A || A !== a.elementHovered) && (S = f ? 1 - S : S,
...
, function(t, e, n) {
    ...
    r.define("navbar", t.exports = function(t, e) {
        var n, o, a, u = {}, c = t.tram, s = t(window), f = t(document), l = r.env(), d = '<div class="w-nav-overlay" data-wf-ignore />', p = ".w-nav", v = "w--open", h = "w--nav-menu-open", y = "w--nav-link-open", g = i.triggers, m = t();
        function b() {
            r.resize.off(w)
        }
        function w() {
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "mediaQueries": ["medium", "small", "tiny", "main"],
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5a4ef7685601d70001c1c087|b81fe04d-7a3e-3bd1-371b-1a249f345e0a"
            },
            "config": {
                "loop": true,
        ...
        "e-4": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5a4ef7685601d70001c1c087|9eb8b5e9-1d0a-bd40-b034-58d03bb1f1a4"
            },
            "config": {
                "loop": false,
        ...
        "e-6": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5a4ef7685601d70001c1c087|ecb9b31d-b3e9-b38a-d7d7-173ab6f27944"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": 0,
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 5000,
                        "target": {
                            "id": "5a4ef7685601d70001c1c087|ff6d43ad-bbbc-82db-76fd-f6db39cc8d55"
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "locked": false,
                        "target": {
                            "id": "5a4ef7685601d70001c1c087|bfaedbe1-c56f-73f1-7c56-7c7b75dbf9e4"
                        },
                        "widthValue": 700,
                        "widthUnit": "PX",
                        "heightUnit": "AUTO"
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "block",
                        "target": {
                            "id": "5a4ef7685601d70001c1c087|7f920107-2f0f-1abf-54de-36049f50ba0a"
                        }
                    }
                }]
            }, {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5a4ef7685601d70001c1c087|6ae6fa55-178d-aec7-ba5b-60fd2c28c9f2"
                            }
                        }
                    }]
                }, {
